...
<title>Atur Ulang Password · SPK Jurusan SMKN 2 Jember</title>
...
.hero-label { display: inline-flex; align-items: center; gap: 8px; background: rgba(37,99,235,.12); border: 1px solid rgba(37,99,235,.3); border-radius: 100px; padding: 6px 14px; font-size: 12px; font-weight: 600; color: #60a5fa; margin-bottom: 22px; animation: fadeUp .6s .1s ease both; }
.hero-label span { width: 6px; height: 6px; border-radius: 50%; background: var(--blue); display: block; }
...
<div class="left">
    ...
    <div class="hero-label"><span></span> Pemulihan Akun</div>
    <h1 class="hero-title">Atur Ulang<br><em>Password</em> Baru</h1>
    <p class="hero-desc">Langkah terakhir untuk mendapatkan kembali akses ke akunmu. Pastikan menggunakan password yang kuat dan unik.</p>
</div>
<div class="vline"></div>
<div class="right">
    <div class="card">
        <div class="card-top">
            <h2>Buat Password Baru 🛠️</h2>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" placeholder="Min. 8 karakter" required autofocus autocomplete="new-password">
            </div>
